...
function iniciarApp(){
    ...
    botonesPaginador(); // cambia a la siguiente pagina 
    paginaSiguiente();
    paginaAnterior();
...
function seleccionarServicio(servicio){
    ...
    //indentificar al elemento al que le da click
...
function mostrarResumen(){
   ...
   //Heading para servicios en Resumen
   const headginCita = document.createElement('H3');
   headginCita.textContent = 'Resumen de Cita';
   resumen.appendChild(headginCita);
...
async function reservarCita() {
    ...
    const url = '/api/citas'; // `${Location.origin}/api/citas`;
